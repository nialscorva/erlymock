-module(erlymock).
-export([await/1,await/2,cleanup/0,signal_fun/2,start/0, expect/5, expect/6, strict/5, strict/4, o_o/4, stub/4, replay/0, verify/0, verify_after_last_call/0, verify_after_last_call/1, invocation_event/1]).
